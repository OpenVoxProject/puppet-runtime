platform "windows-2019-x64" do |plat|
  ...
  # For OpenVox
  # Install the Windows SDK (I'm not sure if I actually ended up using anything here)
  # Ensure the relevant packages are installed via Cygwin (a crapload of them, including ruby/ruby-devel)
  # choco install mingw (also not 100% sure if I'm using this)
  # Install Wix manually

  # We need to ensure we install chocolatey prior to adding any nuget repos. Otherwise, everything will fall over
  # For OpenVox, install these before running the build.
