platform 'windows-msys2-x64' do |plat|
  ...
  plat.provision_with("C:/msys64/usr/bin/pacman.exe -S --noconfirm --needed #{packages.join(' ')};C:/msys64/usr/bin/pacman.exe -Qi mingw-w64-ucrt-x86_64-gcc-libs; ls -la /ucrt64/bin/")
