...
# Notes:
#   2025-07-23: 2.5.0 changes behavior to rep idle connections after 60 seconds by default.
#   We need to test this before upgrading to ensure it doesn't break anything or
#   affect performance. There are no security fixes between 2.4.1 and 2.5.3.
#####
